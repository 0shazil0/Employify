...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const Auth2CreateWidget() : const GetStartedWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Applyingjobpage',
          path: '/applyingjobpage',
          builder: (context, params) => ApplyingjobpageWidget(
            jobref: params.getParam(
              'jobref',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['Job_Collection'],
            ),
            jid: params.getParam(
              'jid',
              ParamType.String,
        ...
        FFRoute(
          name: 'My_JobProfiles',
          path: '/myJobProfiles',
          builder: (context, params) => const MyJobProfilesWidget(),
        ),
        FFRoute(
          name: 'auth_2_Create',
          path: '/auth2Create',
        ...
        FFRoute(
          name: 'CreateJobProfileresume',
          path: '/createJobProfileresume',
          builder: (context, params) => const CreateJobProfileresumeWidget(),
        ),
        FFRoute(
          name: 'MyAppliedApplications',
          path: '/myAppliedApplications',
          builder: (context, params) => const MyAppliedApplicationsWidget(),
        ),
        FFRoute(
          name: 'TrackApplication',
          path: '/TrackApplication',
          builder: (context, params) => TrackApplicationWidget(
            appliedJobRef: params.getParam(
              'appliedJobRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['applied_job'],
            ),
            jobCollectionRef: params.getParam(
              'jobCollectionRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['Job_Collection'],
        ...
        FFRoute(
          name: 'Comapnies',
          path: '/comapnies',
          builder: (context, params) => const ComapniesWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/employment-recruitment-isometric_1284-26082-removebg-preview.png',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
